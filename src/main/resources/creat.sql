...
ALTER TABLE `CoursePlan` ADD CONSTRAINT `course_id` FOREIGN KEY (`course_id`) REFERENCES `Course` (`id`);

ALTER TABLE `CoursePlan` ADD CONSTRAINT `teacher_id` FOREIGN KEY (`teacher_id`) REFERENCES `Teacher` (`id`);

ALTER TABLE `CoursePlan` ADD CONSTRAINT `room_id` FOREIGN KEY (`room_id`) REFERENCES `Room` (`id`);

ALTER TABLE `User_qy` ADD CONSTRAINT `weixin_school` FOREIGN KEY (`school_id`) REFERENCES `School` (`id`);

ALTER TABLE `User_qy` ADD CONSTRAINT `weixin_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `Teacher` (`id`);

ALTER TABLE `Student` ADD CONSTRAINT `student_room` FOREIGN KEY (`room_id`) REFERENCES `Room` (`id`);

ALTER TABLE `User_qy` ADD CONSTRAINT `weixin_parent` FOREIGN KEY (`parent_id`) REFERENCES `Parent` (`id`);

ALTER TABLE `User_qy` ADD CONSTRAINT `weixin_student` FOREIGN KEY (`student_id`) REFERENCES `Student` (`id`);
...
ALTER TABLE `User_dy` ADD CONSTRAINT `dy_school` FOREIGN KEY (`school_id`) REFERENCES `School` (`id`);

ALTER TABLE `User_fw` ADD CONSTRAINT `fw_school` FOREIGN KEY (`school_id`) REFERENCES `School` (`id`);

ALTER TABLE `User_dy` ADD CONSTRAINT `dy_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `Teacher` (`id`);

ALTER TABLE `User_dy` ADD CONSTRAINT `dy_student` FOREIGN KEY (`student_id`) REFERENCES `Student` (`id`);

ALTER TABLE `User_dy` ADD CONSTRAINT `dy_parent` FOREIGN KEY (`parent_id`) REFERENCES `Parent` (`id`);

ALTER TABLE `User_fw` ADD CONSTRAINT `fw_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `Teacher` (`id`);

ALTER TABLE `User_fw` ADD CONSTRAINT `fw_student` FOREIGN KEY (`student_id`) REFERENCES `Student` (`id`);

ALTER TABLE `User_fw` ADD CONSTRAINT `fw_parent` FOREIGN KEY (`parent_id`) REFERENCES `Parent` (`id`);
