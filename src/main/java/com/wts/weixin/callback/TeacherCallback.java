...
import static com.wts.weixin.deal.TeacherDeal.getOutMessage;

public class TeacherCallback extends Controller {
  private static Logger logger = Logger.getLogger(TeacherCallback.class);
