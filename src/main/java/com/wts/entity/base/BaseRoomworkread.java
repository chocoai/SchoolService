...
public abstract class BaseRoomworkread<M extends BaseRoomworkread<M>> extends Model<M> implements IBean {
	...
	public void setRoomworkId(java.lang.Integer roomworkId) {
		set("roomwork_id", roomworkId);
	}

	public java.lang.Integer getRoomworkId() {
		return get("roomwork_id");
	}
