...
public class ParentMobile extends Controller {
  private static Logger logger = Logger.getLogger(ParentMobile.class);
  ...
  public void Page() {
    ...
    if (getSessionAttr("Teacher") == null) {
      ...
      if (getCookie("dit").equals("")) {
        ...
        render("/static/html/mobile/Teacher/Mobile_Teacher_Parent.html");
      }
    } else {
