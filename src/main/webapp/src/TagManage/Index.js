...
import TeacherList from './TagList.vue'
import TeacherAdd from './TagAdd.vue'
import TeacherEdit from './TagEdit.vue'
...
const routes = [
  { path: '/tagList', component: TeacherList },
  { path: '/tagAdd', component: TeacherAdd },
  { path: '/tagEdit/:tagId', component: TeacherEdit },
