      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            sortable: true,
            render (row) {
              const sexes = row.sex.toString() === '1' ? 'male' : row.sex.toString() === '0' ? 'female' : 'person'
              const color = row.sex.toString() === '1' ? '#0099CC' : row.sex.toString() === '0' ? '#CC6699' : 'red'
              const text = row.sex.toString() === '1' ? '男生' : row.sex.toString() === '0' ? '男生' : '错误'
