<template>
  <div>
    ...
    <mu-list>
      <mu-list-item v-for="course in list" :value="course.id" :title="course.name" :afterText="course.state.toString() === '0'?'注销':'激活'" :describeText="course.type.toString() === '1'?'必修课':'选修课'" @click="goEdit(course.id)">
        <mu-icon v-if="course.state.toString() === '0' && course.type.toString() === '1'" slot="left" color="#9e9e9e" value="sentiment_very_dissatisfied" :size="40" />
        <mu-icon v-if="course.state.toString() === '1' && course.type.toString() === '1'" slot="left" color="#8bc34a" value="sentiment_neutral" :size="40" />
        <mu-icon v-if="course.state.toString() === '0' && course.type.toString() === '2'" slot="left" color="#9e9e9e" value="sentiment_very_dissatisfied" :size="40" />
        <mu-icon v-if="course.state.toString() === '1' && course.type.toString() === '2'" slot="left" color="#8bc34a" value="sentiment_neutral" :size="40" />
      </mu-list-item>
    </mu-list>
    <mu-flexbox>
