<template>
  <div>
    ...
    <mu-list>
      <mu-list-item v-for="object in list" :value="object.id" :title="object.name" :afterText="object.state.toString() === '0'?'注销':'激活'" @click="goSheet(object.id, object.state, object.name)">
        <mu-icon v-if="object.state.toString() === '0'" slot="left" color="grey300" value="block" :size="35" />
        <mu-icon v-if="object.state.toString() === '1'" slot="left" color="cyan300" value="beenhere" :size="35" />
      </mu-list-item>
    </mu-list>
    <mu-flexbox>
