...
export const base = 'TeacherDesktop'
...
export const checkMobileForAdd = `${Desktop.Prefix}/${base}/checkMobileForAdd`
export const checkMobileForEdit = `${Desktop.Prefix}/${base}/checkMobileForEdit`
