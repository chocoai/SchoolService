...
export const base = 'TeacherMessageDesktop'
...
export const checkNameForAdd = `${Desktop.Prefix}/${base}/checkNameForAdd`
export const checkNameForEdit = `${Desktop.Prefix}/${base}/checkNameForEdit`
