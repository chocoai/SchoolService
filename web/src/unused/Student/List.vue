  ...
  export default {
    ...
    methods: {
      ...
      roomChange (val) {
        ...
        this.openRoom = false
        this.Reading = true
        this.query(this.queryString, this.pageCurrent, this.pageSize, this.room_id)
        this.total(this.queryString, this.pageSize, this.room_id)
      },
      query (queryString, pageCurrent, pageSize, roomId) {
        this.$http.get(
          API.query,
          { params: {
      ...
      total (queryString, pageSize, roomId) {
        this.$http.get(
          API.total,
          { params: {
            queryString: queryString,
